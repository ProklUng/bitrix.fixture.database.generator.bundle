...
namespace Prokl\BitrixFixtureGeneratorBundle\Services\Utils;
 ...
 * @package Prokl\BitrixFixtureGeneratorBundle\Services\Utils
 *
 * @since 11.04.2021
 */
class FixtureClassLocator
    ...
    private function getAllFixturesClasses() : array
    {
        ...
        foreach ($this->fixtureDirectories as $dir) {
            ...
            foreach ($iterator->type(
                'Prokl\BitrixFixtureGeneratorBundle\Services\Contracts\FixtureInterface'
